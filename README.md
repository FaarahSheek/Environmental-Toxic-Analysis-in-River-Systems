...
The project helps transform raw environmental monitoring data into actionable insights by:
- Identifying the most polluted river systems
- Comparing toxin concentrations across regions
...
- Clean and preprocess datasets with missing environmental measurements
- Perform exploratory data analysis using descriptive statistics
- Visualize environmental data using bar charts, line plots, and heatmaps
...
This project examines multiple water quality indicators, including:
...
### 1. Which river is the most polluted?
...
- Including additional river systems
- Applying seasonal or monthly trend decomposition
...
- **Notebook:** `Environmental_Toxic_Analysis_in_River_Systems.ipynb`  
  Contains all code from data loading and cleaning to visualization and statistical analysis.

- **Dataset:** `National_River_Toxin_Dataset_1.csv`  
  Contains water quality measurements across multiple rivers and dates.
...
2. **Exploratory Data Analysis (EDA)**  
   ...
   - Compared average toxin levels by river system  

3. **Visualization**  
   - Bar charts for average toxin concentrations  
   - Line graphs showing toxin levels over time  
...
- The Yangtze River is the most polluted among the rivers analyzed  
- The Amazon and Danube are the least polluted, likely due to lower industrial activity  
...
- Strengthen industrial waste regulations along highly polluted rivers  
- Invest in wastewater treatment infrastructure near urban areas  
